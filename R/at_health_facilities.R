#' Data about births at health facilities.
#'
#' This tidy data is derived from the `at_health_facilities.csv` file, which in turn is
...
#'   \item{total}{Overall percentage of births at health facilities}
